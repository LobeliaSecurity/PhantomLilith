...
class DefineUtilClass():
    def __init__(self, define_mapping: DefineMapping) -> None:
        self.__strMap__ = {}
        for key in define_mapping:
            self.__define__(key, define_mapping[key])

    def __define__(self, define_key: str, define_value: int) -> None:
        exec(f"self.{define_key} = {define_value}")
...
DebugEventCodes = DefineUtilClass(
    DefineMapping(
        {
    ...
    DefineMapping(
        {
            ...
            "FILTER_FLT_NTSTATUS_FROM_HRESULT": "lambda x: (((x) & 0xC0007FFF) | (FacilityCodes.FACILITY_FILTER_MANAGER << 16) | 0x40000000)",
...
ExceptionCodes = DefineUtilClass(
    DefineMapping(
        {
            "STILL_ACTIVE": StatusCodes.STATUS_PENDING,
            "EXCEPTION_ACCESS_VIOLATION": StatusCodes.STATUS_ACCESS_VIOLATION,
            "EXCEPTION_DATATYPE_MISALIGNMENT": StatusCodes.STATUS_DATATYPE_MISALIGNMENT,
            "EXCEPTION_BREAKPOINT": StatusCodes.STATUS_BREAKPOINT,
            "EXCEPTION_SINGLE_STEP": StatusCodes.STATUS_SINGLE_STEP,
            "EXCEPTION_ARRAY_BOUNDS_EXCEEDED": StatusCodes.STATUS_ARRAY_BOUNDS_EXCEEDED,
            "EXCEPTION_FLT_DENORMAL_OPERAND": StatusCodes.STATUS_FLOAT_DENORMAL_OPERAND,
            "EXCEPTION_FLT_DIVIDE_BY_ZERO": StatusCodes.STATUS_FLOAT_DIVIDE_BY_ZERO,
            "EXCEPTION_FLT_INEXACT_RESULT": StatusCodes.STATUS_FLOAT_INEXACT_RESULT,
            "EXCEPTION_FLT_INVALID_OPERATION": StatusCodes.STATUS_FLOAT_INVALID_OPERATION,
            "EXCEPTION_FLT_OVERFLOW": StatusCodes.STATUS_FLOAT_OVERFLOW,
            "EXCEPTION_FLT_STACK_CHECK": StatusCodes.STATUS_FLOAT_STACK_CHECK,
            "EXCEPTION_FLT_UNDERFLOW": StatusCodes.STATUS_FLOAT_UNDERFLOW,
            "EXCEPTION_INT_DIVIDE_BY_ZERO": StatusCodes.STATUS_INTEGER_DIVIDE_BY_ZERO,
            "EXCEPTION_INT_OVERFLOW": StatusCodes.STATUS_INTEGER_OVERFLOW,
            "EXCEPTION_PRIV_INSTRUCTION": StatusCodes.STATUS_PRIVILEGED_INSTRUCTION,
            "EXCEPTION_IN_PAGE_ERROR": StatusCodes.STATUS_IN_PAGE_ERROR,
            "EXCEPTION_ILLEGAL_INSTRUCTION": StatusCodes.STATUS_ILLEGAL_INSTRUCTION,
            "EXCEPTION_NONCONTINUABLE_EXCEPTION": StatusCodes.STATUS_NONCONTINUABLE_EXCEPTION,
            "EXCEPTION_STACK_OVERFLOW": StatusCodes.STATUS_STACK_OVERFLOW,
            "EXCEPTION_INVALID_DISPOSITION": StatusCodes.STATUS_INVALID_DISPOSITION,
            "EXCEPTION_GUARD_PAGE": StatusCodes.STATUS_GUARD_PAGE_VIOLATION,
            "EXCEPTION_INVALID_HANDLE": StatusCodes.STATUS_INVALID_HANDLE,
            "EXCEPTION_POSSIBLE_DEADLOCK": StatusCodes.STATUS_POSSIBLE_DEADLOCK,
            "CONTROL_C_EXIT": StatusCodes.STATUS_CONTROL_C_EXIT,
        }
    )
)

ContinueStatus = DefineUtilClass(
    DefineMapping(
        {
            "DBG_CONTINUE": StatusCodes.DBG_CONTINUE,
            "DBG_EXCEPTION_NOT_HANDLED": StatusCodes.DBG_EXCEPTION_NOT_HANDLED,
            "DBG_REPLY_LATER": StatusCodes.DBG_REPLY_LATER,
        }
    )
)

PrivilegeAttributes = DefineUtilClass(
    DefineMapping(
        {
            "SE_PRIVILEGE_ENABLED_BY_DEFAULT ": 0x00000001,
            "SE_PRIVILEGE_ENABLED": 0x00000002,
            "SE_PRIVILEGE_REMOVED": 0X00000004,
            "SE_PRIVILEGE_USED_FOR_ACCES": 0x80000000,
            "SE_PRIVILEGE_VALID_ATTRIBUTES": (0x00000001 | 0x00000002 | 0X00000004 | 0x80000000),
        }
    )
)

AccessTypes = DefineUtilClass(
    DefineMapping(
        {
            "DELETE": 0x00010000,
    ...
    DefineMapping(
        {
            ...
            "PROCESS_ALL_ACCESS": (AccessTypes.STANDARD_RIGHTS_REQUIRED | AccessTypes.SYNCHRONIZE | 0xFFFF),
            ...
            "THREAD_ALL_ACCESS": (AccessTypes.STANDARD_RIGHTS_REQUIRED | AccessTypes.SYNCHRONIZE | 0xFFFF),
            "JOB_OBJECT_ASSIGN_PROCESS": 0x0001,
            "JOB_OBJECT_SET_ATTRIBUTES": 0x0002,
            "JOB_OBJECT_QUERY": 0x0004,
            "JOB_OBJECT_TERMINATE": 0x0008,
            "JOB_OBJECT_SET_SECURITY_ATTRIBUTES": 0x0010,
            "JOB_OBJECT_ALL_ACCESS": (AccessTypes.STANDARD_RIGHTS_REQUIRED | AccessTypes.SYNCHRONIZE | 0x1F),
        }
    )
)

ContextFlags = DefineUtilClass(
    DefineMapping(
        {
            "CONTEXT_AMD64": 0x100000,
            "CONTEXT_CONTROL": (0x100000 | 0x1),
            "CONTEXT_INTEGER": (0x100000 | 0x2),
            "CONTEXT_SEGMENTS": (0x100000 | 0x4),
            "CONTEXT_FLOATING_POINT": (0x100000 | 0x8),
            "CONTEXT_DEBUG_REGISTERS": (0x100000 | 0x10),
            "CONTEXT_FULL": ((0x100000 | 0x1) | (0x100000 | 0x2) | (0x100000 | 0x8)),
            "CONTEXT_ALL": ((0x100000 | 0x1) | (0x100000 | 0x2) | (0x100000 | 0x4) | (0x100000 | 0x8) | (0x100000 | 0x10)),
            "CONTEXT_XSTATE": (0x100000 | 0x20),
...
CreateToolhelp32SnapshotFlags = DefineUtilClass(
    DefineMapping(
        {
...
TimeoutInterval = DefineUtilClass(
    DefineMapping(
        {
...
MemoryProtection = DefineUtilClass(
    DefineMapping(
        {
...
ProcessInformationClass = DefineUtilClass(
    DefineMapping(
        {
